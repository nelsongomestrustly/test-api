package cucumber.api.tests.samplefiles.admconsole.enums.files;

import lombok.Getter;

import static cucumber.api.tests.samplefiles.admconsole.constants.AdmConSearchTransactionsFileNames.SEARCH_ADMIN_CONSOLE_TRANSACTIONS_FILE_NAME_BY_CUSTOMER_NAME_EMPTY;
import static cucumber.api.tests.samplefiles.admconsole.constants.AdmConSearchTransactionsFileNames.SEARCH_ADMIN_CONSOLE_TRANSACTIONS_FILE_NAME_BY_CUSTOMER_NAME_INVALID;
import static cucumber.api.tests.samplefiles.admconsole.constants.AdmConSearchTransactionsFileNames.SEARCH_ADMIN_CONSOLE_TRANSACTIONS_FILE_NAME_BY_CUSTOMER_NAME_VALID_1;
import static cucumber.api.tests.samplefiles.admconsole.constants.AdmConSearchTransactionsFileNames.SEARCH_ADMIN_CONSOLE_TRANSACTIONS_FILE_NAME_BY_CUSTOMER_NAME_VALID_2;
import static cucumber.api.tests.samplefiles.admconsole.constants.AdmConSearchTransactionsFileNames.SEARCH_ADMIN_CONSOLE_TRANSACTIONS_FILE_NAME_BY_CUSTOMER_NAME_VALID_3;
import static cucumber.api.tests.samplefiles.admconsole.enums.directories.AdmConTransactionsSampleFilesDirectoriesEnum.ADMIN_CONSOLE_TRANSACTIONS_SEARCH_BY_NAME_SAMPLE_FILES_DIRECTORY;
