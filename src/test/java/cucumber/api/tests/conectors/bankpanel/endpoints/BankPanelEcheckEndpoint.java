...
@AllArgsConstructor
@Getter
public enum BankPanelEcheckEndpoint {

    //index
    //get & post
    BANK_PANEL_ENDPOINT_E_CHECK(BANK_PANEL_ENDPOINT_STEP.getEndpoint() + "/{0}/echeck"),

    //cancel
    //post
    BANK_PANEL_ENDPOINT_E_CHECK_CANCEL(BANK_PANEL_ENDPOINT_E_CHECK.getEndpoint() + "/cancel"),

    //validate
    //post
    BANK_PANEL_ENDPOINT_E_CHECK_VALIDATE(BANK_PANEL_ENDPOINT_E_CHECK.getEndpoint() + "/validate"),

    //authorize
    //post
    BANK_PANEL_ENDPOINT_E_CHECK_AUTHORIZE(BANK_PANEL_ENDPOINT_E_CHECK.getEndpoint() + "/authorize"),

    //back
    //post
    BANK_PANEL_ENDPOINT_E_CHECK_BACK(BANK_PANEL_ENDPOINT_E_CHECK.getEndpoint() + "/back"),

    //trustlyBack
    //post
    BANK_PANEL_ENDPOINT_E_CHECK_TRUSTLY_BACK(BANK_PANEL_ENDPOINT_E_CHECK.getEndpoint() + "/trustlyBack");
