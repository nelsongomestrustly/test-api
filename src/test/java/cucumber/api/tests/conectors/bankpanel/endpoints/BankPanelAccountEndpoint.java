...
@AllArgsConstructor
@Getter
public enum BankPanelAccountEndpoint {

    //index
    BANK_PANEL_ENDPOINT_ACCOUNT(BANK_PANEL_ENDPOINT_STEP.getEndpoint() + "/{0}/account"),

    /**
     * Use to Select with account we will use
     * {0} = BankId
     * authorize
     * post
     */
    BANK_PANEL_ENDPOINT_ACCOUNT_AUTHORIZE(BANK_PANEL_ENDPOINT_ACCOUNT.getEndpoint() + "/authorize"),

    //confirmation
    //post
    BANK_PANEL_ENDPOINT_ACCOUNT_CONFIRMATION(BANK_PANEL_ENDPOINT_ACCOUNT.getEndpoint() + "/confirmation"),

    //validate
    //post
    BANK_PANEL_ENDPOINT_ACCOUNT_VALIDATE(BANK_PANEL_ENDPOINT_ACCOUNT.getEndpoint() + "/validate");
