...
//fi-gateway
//bank-panel
//AuthorizationTextController
@AllArgsConstructor
@Getter
public enum BankPanelAuthorizationEndpoint {

    //index
    //get
    BANK_PANEL_ENDPOINT_AUTHORIZATION(BANK_PANEL_ENDPOINT_STEP.getEndpoint() + "/{0}/authorization"),

    //html
    //post
    BANK_PANEL_ENDPOINT_AUTHORIZATION_HTML(BANK_PANEL_ENDPOINT_AUTHORIZATION.getEndpoint() + "/html"),

    //raw
    //post
    BANK_PANEL_ENDPOINT_AUTHORIZATION_RAW(BANK_PANEL_ENDPOINT_AUTHORIZATION.getEndpoint() + "/raw");
