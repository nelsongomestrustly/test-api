...
@Slf4j
public class BankPanelAuthenticateLoginInfoTransaction_FT extends CucumberTest {
     ...
     *
     */
    @When("The user should be able to open Bank Authorization Screen and Get Login Information and Expect Http Status {string}")
    public void theUserShouldBeAbleToOpenBankAuthorizationScreenAndGetLoginInformationAndExpectHttpStatus(String expectMerchantInfoHttpStatus) throws IOException {
        ...
        BankPanelLoginInfoDTO bankPanelLoginInfoDTO = BankPanelHttpActions.getBankPanelLoginInfoDTO(firstBankPanelRedirectUrlDTO, Integer.parseInt(expectMerchantInfoHttpStatus), BANK_PANEL_INTERCEPTOR_MAP_KEY);

        MyTestContext.getMyTestContext().bankManager.addBankPanelLoginInfoDTO(bankPanelLoginInfoDTO);
    ...
    public void theUserShouldHaveAValidBankLoginInformation() {
        ...
        BankPanelValidation.validateBankLoginInfoDTO.accept(firstBankPanelLoginInfoDTO);
