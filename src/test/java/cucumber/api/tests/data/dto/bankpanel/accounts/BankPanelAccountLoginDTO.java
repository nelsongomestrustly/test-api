...
import cucumber.api.tests.data.dto.bankpanel.login.BankPanelLoginAuthFieldsDTO;
import cucumber.api.tests.data.dto.bankpanel.login.BankPanelLoginBankDictionaryDTO;
import cucumber.api.tests.data.dto.bankpanel.login.BankPanelLoginPageDTO;
import cucumber.api.tests.data.dto.bankpanel.login.BankPanelLoginTransactionDTO;
...
@AllArgsConstructor
@Builder
public class BankPanelAccountLoginDTO {

 private List<BankPanelAccountFieldsDTO> accountFields;
 private QueryParametersEnum accountFieldsKey = QueryParametersEnum.ACCOUNT_FIELDS;

 private BankPanelAccountPageDTO page;
 private QueryParametersEnum pageKey = QueryParametersEnum.PAGE;

 private BankPanelAccountSelectDTO selectedAccount;
 private QueryParametersEnum selectedAccountKey = QueryParametersEnum.SELECTED_ACCOUNT;

 private BankPanelAccountTransactionDTO transaction;
 private QueryParametersEnum transactionKey = QueryParametersEnum.TRANSACTION;


 //Strings
 private String askForAccountProfile;
 private QueryParametersEnum askForAccountProfileKey = QueryParametersEnum.ASK_FOR_ACCOUNT_PROFILE;
