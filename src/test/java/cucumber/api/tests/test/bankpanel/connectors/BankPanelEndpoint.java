...
public enum BankPanelEndpoint {
     ...
     * authenticate
     */
    BANK_PANEL_ENDPOINT_AUTHENTICATION_AUTHENTICATION(BANK_PANEL_ENDPOINT.getEndpoint() + "/{0}/authentication/authenticate"),
     ...
     * authorize
     */
    BANK_PANEL_ENDPOINT_ACCOUNT_AUTHORIZE(BANK_PANEL_ENDPOINT.getEndpoint() + "/{0}/account/authorize");
