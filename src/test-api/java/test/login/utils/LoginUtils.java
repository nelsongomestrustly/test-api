...
import static test.login.common.LoginConstants.COOKIE_END;
import static test.login.common.LoginConstants.COOKIE_START;
import static test.login.common.LoginConstants.FIRST_COOKIE_END;
import static test.login.common.LoginConstants.FIRST_COOKIE_START;
import static test.login.common.LoginConstants.SECOND_COOKIE_END;
import static test.login.common.LoginConstants.SECOND_COOKIE_START;
import static test.login.common.LoginConstants.THIRD_COOKIE_END;
import static test.login.common.LoginConstants.THIRD_COOKIE_START;
